...
export const Protask: Project = {
  ...
  description: [
    <span key={0}>
      An online platfom that user connect with each other and assign task and projects to those people they connected with.
    </span>,
    <span key={1}>
      This is the Capstone project for my univeristy degree for the course COMP3900.
    </span>,
    <span key={2}>
      Collaborated with 3 students to develop a Python-Flask backend for a task management system, enabling users to search, post, and assign tasks to other users in their network. 
    </span>,
    <span key={3}>
